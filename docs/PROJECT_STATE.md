...
- Original AppKit foundation added with no FFmpeg integration; local Debug build and three automated tests pass on the current x86_64 development machine.

## Immediate priorities

1. Build and test the original AppKit foundation locally.
